...
function SignUp() {
  ...
  const [highestQulalification , setHighestQualification] = useState("")
...
return (
  ...
  <div>
    {isSubmit ? (
      ...
      <FormComponent setName = {setName} setEmail = {setEmail} setAge={setAge} setGender={setGender} setHighestQualification = {setHighestQualification} setPassword={setPassword} setSkills={setSkills} setisSubmit={setisSubmit}/>
    )}
  </div>
);
